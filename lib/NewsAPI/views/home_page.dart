...
import 'package:the_news_app/NewsAPI/widgets/custom_appbar.dart';
import 'package:the_news_app/NewsAPI/widgets/news_card.dart';

import 'package:carousel_slider/carousel_slider.dart';
import 'package:the_news_app/NewsAPI/views/web_view_news.dart';
            ...
            children: [
              Flexible(
                child: Container(
                  ...
                  margin: const EdgeInsets.symmetric(horizontal: Sizes.dimen_18, vertical: Sizes.dimen_16),
                  decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(Sizes.dimen_8)),
                  child: Row(
                  ...
                  return CarouselSlider(
                    ...
                    items: controller.breakingNews.map((instance) {
                      return controller.articleNotFound.value 
                        ...
                        ): controller.breakingNews.isEmpty ? const Center(child: CircularProgressIndicator(),
              ...
              GetBuilder<NewsController>(
                builder: (controller){
                  return controller.articleNotFound.value ? const Center(
                    child: Text('Nothing Found'),
                  ) : controller.allNews.isEmpty ? const Center(child: CircularProgressIndicator(),) : 
                  ListView.builder(
                    ...
                    itemBuilder: (contex, index){
                      index == controller.allNews.length - 1 && controller.isLoading.isTrue ? const Center(
                    ...
                    return InkWell(
                      ...
                      child: NewsCard(
                        imgUrl: controller.allNews[index].urlToImage ?? '',
                        desc: controller.allNews[index].description ?? '',
                        title: controller.allNews[index].title ,
                        content: controller.allNews[index].content ?? '',
